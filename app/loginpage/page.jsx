...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost/sportscoach/app/api_sports/loginphp/loginform.php",
        { username, password }
      );

      if (response.data.success) {
        const { user_id, username, role_name, photo_url , email , address , age, contact , firstname , lastname , middlename} = response.data;
        ...
        sessionStorage.setItem("firstname", encryptData(firstname));
        sessionStorage.setItem("lastname", encryptData(lastname));
        sessionStorage.setItem("middlename", encryptData(middlename));
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/alubijid.png')" }}
    >
      <ToastContainer
        position="top-right"
        autoClose={1000}
      ...
      >
        <motion.div
          className="flex flex-col items-center justify-center w-1/2 text-white p-8 border-r border-black bg-green-800 bg-opacity-90"
        ...
        >
          ...
          >
            ...
            <h1 className="text-white font-semibold text-xl">
              SCB Management System & Revenue
            </h1>
            <h1 className="text-white font-semibold text-xl pl-12">
