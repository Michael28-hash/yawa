...
import ViewapplycoachManagement from "./components/viewapplycoach";
import ActivityManagement from "./components/activitylogs";
import BookingManagement from "./components/bookinginformation";
import AccountManagement from "./components/manageaccount";
import PaymentManagement from "./components/managepayment";
import RateManagement from "./components/manageRate/managerate";
import AvailabilityManagement from "./components/viewavailabilitycoach";
import AdminReports from "./components/report";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {currentView === "bookinginformation" && <BookingManagement />}
        {currentView === "account" && <AccountManagement />}
        {currentView === "viewapplycoach" && <ViewapplycoachManagement />}
        {/* {currentView === "managerate" && <RateManagement />} */}
        {currentView === "availablecoach" && <AvailabilityManagement />}
        {currentView === "payment" && <PaymentManagement />}
