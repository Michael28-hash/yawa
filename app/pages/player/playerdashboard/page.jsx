...
// import CoachList from "./components/BrowseCoach";
import Paymentpage from "./components/Paymentpage";
import RateCoach from "./components/RateCoach";
import TrackHistory from "./components/TrackHistory";
import Profile from "./components/Playerprofile";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {currentView === "booksession" && <BookSession />}
        {currentView === "attendsession" && <AttendSession />}
        {/* {currentView === "browsecoach" && <CoachList />} */}
        {currentView === "payment" && <Paymentpage />}
        {currentView === "ratecoach" && <RateCoach />}
        {currentView === "trackhistory" && <TrackHistory />}
      </motion.div>
    </PlayerLayout>
  );
};
